...
\subsubsection{Usage Characteristics}\label{sec:usage}
...
\begin{table}[ht]
	...
	\begin{tabular}{|c| c| c| c| c|}
		...
		\hline
		Human Powered & Raleigh Furley & 16 & 18-19 & 0\\[0.1ex]	
		\hline
	\end{tabular}
\label{table:usage}
\end{table}
...
\subsection{Concessions in Design Implementation} \label{sec:Tradeoff}
