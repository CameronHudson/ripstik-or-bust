...
The first concern when implementing LQR control was the effect of the nonholonomic constraints on the linearization process. To validate the result discussed in section \ref{sec:linnonholo}.
\subsubsection{Test Case}
