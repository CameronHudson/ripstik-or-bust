...
\paragraph{Symbolic Matrix Inversion}
...
\paragraph{System of Linear Equations (Ax=b)}
...
The complexity of the RipStik system led to computations that exceeded the computers abilities for the symbolic matrix inversion and system of linear equations.
