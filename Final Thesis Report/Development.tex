...
\item The configurability of each method was evaluated qualitatively based on the number of tuneable parameters that could be used to generate a greater length of output
\end{itemize}
...
\begin{table}[ht]
	...
	\begin{tabular}{|c| c| c| c| c|}
		...
		\hline
		Configurability & Poor & Excellent & Good & Poor\\ [0.1ex]
		\hline
	\end{tabular}
