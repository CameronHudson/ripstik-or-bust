...
\par
A body-fixed coordinate system for the RipStik was developed such that the origin was placed at the centre of the torsion bar. The $X-Y$ plane will be parallel with the RipStik deck at rest with no torsion applied.
