...
SessionTime[]
EulerLagrange[t] = EulerEquations[Lagrangian[[1]][[1]],conf,t]
SessionTime[]
...
Dimensions[EulerLagrange[t]]
AccelCoefficientMatrix = Normal[CoefficientArrays[EulerLagrange[t],accel]][[2]]
VelCoefficientMatrix = CoefficientArrays[EulerLagrange[t],vel][[3]]
...
EquationSystem2 = Solve[LHSide == RHSide, {\[Lambda]1,\[Lambda]2,\[Lambda]3,\[Lambda]4}]
